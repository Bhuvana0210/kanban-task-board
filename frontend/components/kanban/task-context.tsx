/**
 * TaskContext and TaskProvider
 * 
 * Defines a global context for managing Kanban board task data and UI state.
 * 
 * Features include:
 * - Storing and persisting task list with add, edit, delete, and status change operations.
 * - Managing search filter query for task filtering.
 * - Managing theme preference (light/dark) with persistent storage.
 * - Provides shared context value with these states and functions to child components.
 * - Custom hook `useTasks` to conveniently access and manipulate task context.
 * - Uses React hooks and memoization to optimize performance and avoid unnecessary re-renders.
 * 
 * This centralized state management enables consistent and synchronized task and UI handling
 * across the entire Kanban application.
 */
