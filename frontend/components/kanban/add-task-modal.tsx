 ...
 * 
 * This React functional component renders a modal dialog for adding or editing a kanban task.
 * 
 * It manages form input state (title, description, status) using React hooks (useState).
 * When opened or given an initial task, it resets input fields accordingly (useEffect).
 * 
 * The form includes validation to ensure the title is non-empty before submitting.
 * On submission, it calls a callback function (onSubmit) passed as a prop, sending the trimmed task data.
 * It also supports cancelling (closing) the modal without saving changes.
 * 
 * Accessible markup with proper ARIA roles and labels is included for screen readers.
 * 
 * This component is designed to be reusable for both adding new tasks and editing existing ones
 * through customizable input props like initialTask and submitLabel.
 */
